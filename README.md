...
- Priorização baseada no fluxo principal do sistema
- Matriz de risco considerando impacto e probabilidade

A análise prioriza o fluxo principal de cadastro e a validação de campos obrigatórios, por apresentarem maior impacto para o negócio.
